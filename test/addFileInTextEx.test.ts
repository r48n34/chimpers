...
describe("addFileInText function testing", () => {
    ...
    test("addFileInText normal text", async () => {
        ...
        let text = addFileInText(carrierText, fileData as any);
    ...
    test("addFileInText with empty string", async () => {
        ...
        expect(() => {
            addFileInText(carrierText, fileData as any);
        }).toThrow(
            new Error(
                "addFileInText function missing text input in params 'text'.",
            ),
        );
    });
    ...
    test("addFileInText with multiple spaces", async () => {
        ...
        const originalWords =
            carrierText.split(" ").filter((w) => w.length > 0).length;
    ...
    test("addFileInText with txt file", async () => {
        ...
        const carrierText = "hello mate I am peter.";
        let text = addFileInText(carrierText, txtFileData as any);
        let decodedFile = decodeFileInText(text);
    ...
    test("addFileInText with png file", async () => {
        ...
        let text = addFileInText(carrierText, pngFileData as any);
        let decodedFile = decodeFileInText(text);
    ...
    //     let text = addFileInText(carrierText, arrayBuffer);
    //     let decodedFile = decodeFileInText(text);
    ...
    test("addFileInText with Uint8Array input", async () => {
        ...
        let text = addFileInText(carrierText, uint8Array);
        let decodedFile = decodeFileInText(text);
